  ...
  Widget _type2() {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          text,
          style: AppFont.componentMediumBold.copyWith(color: AppColor.ink02),
        ),
      ),
    );
  }
  ...
  Widget _type3() {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          text,
          style: AppFont.componentLarge.copyWith(color: AppColor.ink02),
        ),
      ),
    );
  }
...
enum DisableButtonType { type1, type2, type3 }
